...
namespace NuGet.PackageManagement
{
    public class PackageRestoreConsent
    {
        ...
        public bool IsGrantedInSettings
        {
            ...
            set
            {
                _settings.AddOrUpdate(PackageRestoreSection, new AddItem(PackageRestoreConsentKey, value.ToString()));
        ...
        public bool IsAutomatic
        {
            ...
            set
            {
                _settings.AddOrUpdate(PackageRestoreSection, new AddItem(PackageRestoreAutomaticKey, value.ToString()));
                _settings.SaveToDisk();
            }
        }
